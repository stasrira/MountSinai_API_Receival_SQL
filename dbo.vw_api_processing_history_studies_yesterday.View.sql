...
GO
create view [dbo].[vw_api_processing_history_studies_yesterday]
as
with meta_hist as (
...
and h.datetime_stamp between t.[beginOfYesterday] and t.[beginOfToday] --select records from yesterday
